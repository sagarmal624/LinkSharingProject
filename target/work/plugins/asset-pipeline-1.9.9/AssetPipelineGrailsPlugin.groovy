...
class AssetPipelineGrailsPlugin {
    ...
    def authorEmail     = "destes@bcap.LinkSharing"
    ...
    def license         = "APACHE"
    def organization    = [ name: "Bertram Capital", url: "http://www.bertramcapital.LinkSharing/" ]
    def issueManagement = [ system: "GITHUB", url: "http://github.LinkSharing/bertramdev/asset-pipeline/issues" ]
    def scm             = [ url: "http://github.LinkSharing/bertramdev/asset-pipeline" ]
    def pluginExcludes  = [
        "grails-app/assets/**",
        "test/dummy/**"
    ]
